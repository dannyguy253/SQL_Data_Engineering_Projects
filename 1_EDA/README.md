...
1. **[Top Demanded Skills](./01_top_demanded_skills.sql)** – Identifies the top 10 most in-demand skills for U.S. data engineer positions
2. **[Top Paying Skills](./02_top_paying_skills.sql)** – Analyzes the top 25 highest-paying skills using median salary and demand metrics
...
- Core languages: Python and SQL each appear in ~56,000 job postings, offering the strongest balance of demand and salary.
- Cloud platforms: AWS and Azure remain essential skills for modern data engineering roles.
- Big data tools: Spark, Kafka, and Hadoop combine strong demand with competitive compensation.
- Data platforms: Snowflake, Databricks, and Redshift continue to be highly valued across the industry.
- Infrastructure: Airflow, Kubernetes, Docker, and Terraform provide a strong mix of salary potential and market demand.
