...
/*
Prompt:
Take a look at this and see of any trends you see with this. Went thru and do a breakdown of the top 
demanded skills specifically the top 5 and do any key takeaways of the top 10 as a list. No need to be this 
verbose and how you go through and define it. This will pay off on what you are seeing here before we go 
forward with building out our final README. Because in the README, we are not just going over how the project is 
defined and what we are trying to do with it, we will have a section at the bottom talking about our analysis overview 
and what we found out overall.
